                          ...
                          children: [
                            ...
                            if (_selectedAccountType != 'Treasury Bill') ...[
                              TextFormField(
                                ...
                                decoration:
                                    _getInputDecoration('Account Name/Number'),
                                validator: (value) {
                                  if (_selectedAccountType != 'Treasury Bill' &&
                              ...
                              TextFormField(
                                ...
                                decoration: _getInputDecoration('Balance',
                                    prefixText: 'Rs '),
                            ...
                            if (_selectedAccountType == 'Fixed Deposit') ...[
                              TextFormField(
                                readOnly: true,
                                decoration:
                                    _getInputDecoration('Start Date').copyWith(
                              ...
                              TextFormField(
                                readOnly: true,
                                decoration: _getInputDecoration('Maturity Date')
                                    .copyWith(
                                  suffixIcon: IconButton(
                                    icon: const Icon(Icons.calendar_today),
                                    onPressed: () async {
                              ...
                              TextFormField(
                                ...
                                decoration:
                                    _getInputDecoration('Interest Rate (%)'),
                                keyboardType: TextInputType.number,
                                validator: (value) {
                            ...
                            if (_selectedAccountType == 'Treasury Bill') ...[
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                decoration:
                                    _getInputDecoration('Instrument Type'),
                              ...
                              if (_selectedInstrumentType == 'bond') ...[
                                ...
                                TextFormField(
                                  readOnly: true,
                                  decoration:
                                  _getInputDecoration('Next Coupon Date')
                                      .copyWith(
                                    suffixIcon: IconButton(
                                      icon: const Icon(Icons.calendar_today),
                                      onPressed: () async {
                              ...
                              TextFormField(
                                ...
                                decoration: _getInputDecoration('Face Value',
                                        prefixText: 'Rs ')
                                    .copyWith(
                                  enabled: true,
                                      ...
                                      if (_selectedBank != null) {
                                        final account = BankAccount(
                                          ...
                                          maturityDate: (_selectedAccountType ==
                                              ...
                                              ? _maturityDate
                                              : null,
                                          interestRate: _selectedAccountType ==
                                                  'Fixed Deposit'
                                              ? double.parse(
                                          ...
                                          instrumentType:
                                              _selectedAccountType ==
                                                  ...
                                                  : null,
                                          period: _selectedAccountType ==
                                                  'Treasury Bill'
                                              ? int.parse(_selectedTBillPeriod!)
                                              : null,
                                          isin: _selectedAccountType ==
                                                  'Treasury Bill'
                                          ...
                                          dealSlipNumber:
                                              _selectedAccountType ==
                                                      'Treasury Bill'
                                                  ? _dealSlipNumberController
                                                      .text
                                                  : null,
                                          faceValue: _selectedAccountType ==
                                                      'Treasury Bill' &&
                                                  _faceValueController
                                                      .text.isNotEmpty
                                              ? double.parse(
                                                  _faceValueController.text)
                                              : null,
                                          ...
                                          couponRate: _selectedAccountType ==
                                                  ...
                                                  _selectedInstrumentType ==
                                                      'bond' &&
                                                  _couponRateController
                                                      .text.isNotEmpty
                                              ? double.parse(
                                                  _couponRateController.text)
                                              : null,
                                          nextCouponDate:
                                              _selectedAccountType ==
                                                          'Treasury Bill' &&
